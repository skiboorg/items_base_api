    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_can_add_items', models.BooleanField(default=False, verbose_name='может ли делать пополнение')),
                ('is_can_remove_items', models.BooleanField(default=False, verbose_name='может ли делать расход')),
                ('is_local_admin', models.BooleanField(default=False, verbose_name='локальный админ')),
